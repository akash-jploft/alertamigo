...
class VerifyNewEmailPage extends StatefulWidget {
  static const routeName = "verify-new-email-page";

  const VerifyNewEmailPage({Key? key}) : super(key: key);
...
class _RoundedWithCustomCursorState extends State<VerifyNewEmailPage> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Enter the code sent to example@address.com.au",
                  ...
                  child: Pinput(
                    ...
                    validator: (value) {
                      if (value != null && value.length == 5) {
                        Constants.getToast(msg: "Your email gets updated");
