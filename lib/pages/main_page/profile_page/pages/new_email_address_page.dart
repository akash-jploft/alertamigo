...
class NewEmailInputPage extends StatefulWidget {
  ...
  @override
  State<NewEmailInputPage> createState() => _EmailInputPageState();
}

class _EmailInputPageState extends State<NewEmailInputPage> {
                ...
                onTap: () {
                  if (isValid) {
                    Navigator.of(context)
                        .pushNamed(VerifyNewEmailPage.routeName);
                  }
                },
                title: "Continue"),
            const SizedBox(
